...
namespace ShaderControl
{
	public class SCWindow : EditorWindow
	{
		...
		void ScanProject ()
		{
			...
			shaders.ForEach ((SCShader shader) => shader.UpdateVariantCount ());

			shaders.Sort ( (SCShader x, SCShader y) => { return y.actualBuildVariantCount.CompareTo(x.actualBuildVariantCount); } );
			UpdateProjectStats ();
		}
