Shader "NatureManufacture Shaders/Tree Leaves Specular Snow"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult347 = (fixed2(ase_worldPos.x , ase_worldPos.z));
			...
			float4 lerpResult51 = lerp( ( lerpResult352 * tex2DNode3 ) , ( tex2D( _SnowAlbedoRGB, uv_SnowAlbedoRGB ) - fixed4( appendResult121 , 0.0 ) ) , lerpResult334);
