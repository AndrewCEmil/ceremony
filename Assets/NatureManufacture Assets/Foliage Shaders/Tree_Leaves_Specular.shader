Shader "NatureManufacture Shaders/Tree_Leaves_Specular"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			fixed4 tex2DNode3 = tex2D( _MainTex, i.uv_texcoord );
			float3 ase_worldPos = i.worldPos;
			float2 appendResult357 = (fixed2(ase_worldPos.x , ase_worldPos.z));
			...
			o.Albedo = ( tex2DNode3 * lerpResult363 ).rgb;
			o.Specular = ( tex2DNode3 * _SpecularPower ).rgb;
			fixed4 tex2DNode37 = tex2D( _AmbientOcclusionGSmoothnessA, i.uv_texcoord );
