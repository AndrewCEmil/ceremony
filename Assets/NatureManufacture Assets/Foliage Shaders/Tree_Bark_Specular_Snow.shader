...
#define _SnowAmbientOcclusionPower_arr NatureManufactureShadersTreeBarkSpecularSnow
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float3 appendResult48 = (fixed3(break22.r , break22.g , break22.b));
			...
			float clampResult66 = clamp( tex2D( _DetailAmbientOcclusionG, staticSwitch157 ).g , ( 1.0 - _DetailAmbientOcclusionPower_Instance ) , 1.0 );
