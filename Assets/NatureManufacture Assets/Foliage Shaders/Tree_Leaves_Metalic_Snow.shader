Shader "NatureManufacture Shaders/Tree Leaves Metalic Snow"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 appendResult299 = (fixed2(ase_worldPos.x , ase_worldPos.z));
			...
			float4 lerpResult51 = lerp( ( lerpResult304 * tex2DNode3 ) , ( tex2D( _SnowAlbedoRGB, uv_SnowAlbedoRGB ) - fixed4( appendResult100 , 0.0 ) ) , lerpResult290);
		...
		ENDCG
		CGPROGRAM
		#pragma surface surf Standard keepalpha fullforwardshadows exclude_path:deferred dithercrossfade 
