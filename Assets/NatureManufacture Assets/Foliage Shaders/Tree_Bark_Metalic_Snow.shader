...
#define _SnowAmbientOcclusionPower_arr NatureManufactureShadersTreeBarkMetalicSnow
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float lerpResult38 = lerp( ( break22.r * _MetalicPower_Instance ) , ( tex2DNode45.r * _SnowMetalicPower_Instance ) , temp_output_33_0);
			...
			float lerpResult37 = lerp( ( break22.a * _SmothnessPower_Instance ) , ( tex2DNode45.a * _SnowSmothnessPower_Instance ) , temp_output_33_0);
			...
			float clampResult59 = clamp( break22.g , ( 1.0 - _AmbientOcclusionPower_Instance ) , 1.0 );
